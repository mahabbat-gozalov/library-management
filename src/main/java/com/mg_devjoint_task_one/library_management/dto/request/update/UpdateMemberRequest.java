...
@Schema(description = "Payload used to update an existing member's information")
public record UpdateMemberRequest(
        ...
        @Schema(description = "AZ phone number in the format: +994 XX XXX XX XX (XX must be a valid operator code)",
